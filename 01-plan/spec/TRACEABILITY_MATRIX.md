...
| **REQ-DISC-01** | Stack & Framework Detection | [SPEC-PLAN-001-discovery.md](SPEC-PLAN-001-discovery.md) | `tools/context_discovery.py:11`, `tools/context_discovery.py:30` | `tests/test_context_discovery.py:4`, `tests/test_context_discovery.py:29` | 🟢 VERIFIED |
| **REQ-DISC-02** | Structural Boundary Discovery | [SPEC-PLAN-001-discovery.md](SPEC-PLAN-001-discovery.md) | `tools/context_discovery.py:12`, `tools/context_discovery.py:128` | `tests/test_context_discovery.py:5`, `tests/test_context_discovery.py:37` | 🟢 VERIFIED |
| **REQ-DISC-03** | Interface & Route Discovery | [SPEC-PLAN-001-discovery.md](SPEC-PLAN-001-discovery.md) | `tools/context_discovery.py:13`, `tools/context_discovery.py:153` | `tests/test_context_discovery.py:6`, `tests/test_context_discovery.py:49` | 🟢 VERIFIED |
| **REQ-DISC-04** | Context Snapshotting | [SPEC-PLAN-001-discovery.md](SPEC-PLAN-001-discovery.md) | `tools/context_discovery.py:14`, `tools/context_discovery.py:199` | `tests/test_context_discovery.py:7`, `tests/test_context_discovery.py:58` | 🟢 VERIFIED |
| **REQ-HAND-01** | Git Commitment Automation | [SPEC-PLAN-006-handoff.md](SPEC-PLAN-006-handoff.md) | `tools/plan_runner.py:15`, `tools/plan_runner.py:232` | `workflows/ticketless-plan.md:15`, `workflows/jira-plan.md:16` | 🟢 VERIFIED |
| **REQ-HAND-02** | Provenance & Metadata Injection | [SPEC-PLAN-006-handoff.md](SPEC-PLAN-006-handoff.md) | `tools/plan_runner.py:16`, `tools/plan_runner.py:233` | `workflows/ticketless-plan.md:16`, `workflows/jira-plan.md:17` | 🟢 VERIFIED |
| **REQ-HAND-03** | 02-exe Intake & Pull Protocol | [SPEC-PLAN-006-handoff.md](SPEC-PLAN-006-handoff.md) | `tools/plan_runner.py:17`, `tools/plan_runner.py:303` | `workflows/plan-commit-handoff.md:15`, `tests/test_plan_runner.py:11` | 🟢 VERIFIED |
...
| **REQ-TASK-03** | DAG Validation & Cycle Detection | [SPEC-PLAN-003-decomposition.md](SPEC-PLAN-003-decomposition.md) | `tools/task_graph.py:9`, `tools/task_graph.py:112` | `tests/test_task_graph.py:6`, `tests/test_task_graph.py:107` | 🟢 VERIFIED |
| **REQ-TASK-04** | Topological Wave Batching | [SPEC-PLAN-003-decomposition.md](SPEC-PLAN-003-decomposition.md) | `tools/task_graph.py:10`, `tools/task_graph.py:170` | `workflows/examples/task-breakdown-step.md:5`, `tests/test_task_graph.py:7` | 🟢 VERIFIED |
| **REQ-WORK-01** | Jira-Driven Planning Workflow | [SPEC-PLAN-004-workflows.md](SPEC-PLAN-004-workflows.md) | `tools/jira_client.py:11`, `tools/jira_client.py:53` | `workflows/jira-plan.md:14`, `workflows/authoring-guide.md:28` | 🟢 VERIFIED |
...
| **REQ-WORK-03** | Jira Two-Way Synchronization | [SPEC-PLAN-004-workflows.md](SPEC-PLAN-004-workflows.md) | `tools/jira_client.py:12`, `tools/jira_client.py:114` | `workflows/jira-plan.md:15`, `workflows/examples/jira-sync-step.md:3` | 🟢 VERIFIED |
